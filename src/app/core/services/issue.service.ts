...
export class IssueService {
  ...
  getIssuesByColumn(): Observable<IssuesByColumn> {
    ...
    return this.http.get<{ issues: IssuesByColumn }>('/dashboard/assets/mock-data/issues.json')
      .pipe(
        timeout(2000),
  ...
  getColumns(): Observable<Column[]> {
    return this.http.get<{ columns: Column[] }>('/dashboard/assets/mock-data/columns.json')
      .pipe(
        timeout(1000),
  ...
  getIssueTypes(): Observable<IssueType[]> {
    return this.http.get<IssueType[]>('/dashboard/assets/mock-data/issue-types.json')
      .pipe(
        timeout(1000),
      );
  }
